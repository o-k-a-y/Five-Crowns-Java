...
public class CardModel implements Comparable<CardModel> {
    ...
    /** Default face and suit if invalid suit/face given */
...
//        Log.d("is joker:", Boolean.toString(joker));
    ...
    /**
     * Purpose: Allow printing of card's
     * @return a string, representing the card (i.e., if suit is H and face is 3, "3H")
     */
