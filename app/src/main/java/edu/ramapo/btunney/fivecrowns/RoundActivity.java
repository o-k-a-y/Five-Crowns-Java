...
public class RoundActivity extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_round);
        View someView = findViewById(R.id.drawButton);
...
//            final RoundModel onClickRoundModel = roundModel;
            ...
            topOfDiscard.setBackgroundColor(getResources().getColor(R.color.niceGreen));
            ImageButton topOfDraw = (ImageButton) onClickDrawPileLinearLayout.getChildAt(0);
            topOfDraw.setBackgroundColor(getResources().getColor(R.color.niceGreen));
    ...
    public void goOutOnClick(View view) {
        ...
        nextButton.setBackgroundColor(getResources().getColor(R.color.niceGreen));
        ...
        computerPlayerTextView.setBackgroundColor(getResources().getColor(R.color.niceGreen));
    ...
    public void nextTurnOnClick(View view) {
        ...
        TextView humanPlayerTextView = findViewById(R.id.humanTextView);
        humanPlayerTextView.setBackgroundColor(getResources().getColor(R.color.niceGreen));
        TextView computerPlayerTextView = findViewById(R.id.computerTextView);
...
//            gameModel.updatePlayersScores();
    ...
    private void initializeGameScreen(boolean humanFirstPlayer) {
        ...
        roundView = new RoundView(roundModel, helpButton, goOutButton, currentRoundTextView, computerScoreTextView, humanScoreTextView, currentWildTextView, discardButton);
        roundView.updateGameCards();
        enableEverything(false);
        ...
        if (humanFirstPlayer) {
            ...
            findViewById(R.id.humanTextView).setBackgroundColor(getResources().getColor(R.color.niceGreen));
        } else {
            enableButton(findViewById(R.id.nexTurnButton), true);
            enableButton(findViewById(R.id.saveButton), true);
            ...
            findViewById(R.id.computerTextView).setBackgroundColor(getResources().getColor(R.color.niceGreen));
        }

        // Make text not in buttons golden
        makeTextGolden();
    }

    /**
     * Purpose: Make the text of the screen golden for readability
     */
    private void makeTextGolden() {
        TextView textView = (TextView)findViewById(R.id.currentRoundText);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.wildCardTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.humanScoreTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.computerScoreTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.computerTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.humanTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.discardPileTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
        textView = findViewById(R.id.drawPileTextView);
        textView.setTextColor(getResources().getColor(R.color.golden));
    ...
    private void makeButtonGreen(Button button, boolean makeGreen) {
        if (makeGreen) {
            button.setBackgroundColor(getResources().getColor(R.color.niceGreen));
        } else {
    ...
    public void helpOnClick(View view) {
        ...
        switch (roundModel.playerList[1].getPlayStatus()) {
            ...
            case Begun:
            case Drawing:
                computersHelp = ComputerModel.help(roundModel.getHumanHand(), roundModel.getDrawPile(), roundModel.getDiscardPile(), ComputerModel.Help.DrawHelp);
                break;
            case Drawn:
            case Discarding:
                computersHelp = ComputerModel.help(roundModel.getHumanHand(), roundModel.getDrawPile(),roundModel.getDiscardPile(), ComputerModel.Help.DiscardHelp);
                break;
            case Discarded:
                computersHelp = ComputerModel.help(roundModel.getHumanHand(), roundModel.getDrawPile(),roundModel.getDiscardPile(), ComputerModel.Help.GoOutHelp);
                break;
            case GoneOut:
                break;
            default:
