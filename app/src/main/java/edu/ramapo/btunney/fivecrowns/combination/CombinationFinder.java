...
//    private Vector<CardModel> initialCards;
    ...
    /**
     * Purpose: Take in the player's hand to construct a CombinationFinder object
     * @param cards a CardVectorModel representing the player's hand
     */
 ...
 *          First try highest valued card in the remaining cards
    ...
    public Pair<String, String> getBestCardToDiscard() {
        ...
        // 1 card remaining means remove that card
        ...
        // Remove highest value non wild/joker after making books/runs
        // Remove highest valued wild/joker if they are all wild/joker (shouldn't ever be the case)
