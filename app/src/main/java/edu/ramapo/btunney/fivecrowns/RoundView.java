...
public class RoundView {
    ...
    public RoundView(RoundModel roundModel, View helpButton, View goOutButton, TextView currentRoundTextView, TextView computerScoreTextView, TextView humanScoreTextView, TextView currentWildCardTextView, View discardButton) {
    ...
    /**
     * Purpose: Update the current round being displayed
     */
    ...
    /**
     * Purpose: Update the current scores being displayed
     */
    ...
    /**
     * Purpose: Update the current wild card being displayed
     */
...
//                v.setBackgroundColor(Color.GREEN);
                ...
                // After discarding, the player must be able to go out
                helpButton.setEnabled(true);
                goOutButton.setEnabled(true);

                // Prevent user from discarding 2 cards
                discardButton.setEnabled(false);
                Button button = new Button(goOutButton.getContext());
                discardButton.setBackground(button.getBackground());

                goOutButton.setBackgroundColor(Color.GREEN);
                Button goOut = (Button)goOutButton;
                goOut.setBackgroundColor(ContextCompat.getColor(goOut.getContext(),  R.color.niceGreen));
