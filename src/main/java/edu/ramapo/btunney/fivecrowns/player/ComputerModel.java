...
public class ComputerModel extends PlayerModel
{
     ...
     */
    public static String help(CardVectorModel hand, CardVectorModel discardPile, Help typeOfHelp)
    {
        String suggestion = "";
        String reason = "";
        ...
        switch(typeOfHelp)
        {
            case DrawHelp:
                ...
                if (topOfDiscard.isJoker() || topOfDiscard.isWildCard()) {
                    ...
                    pile = "discard";
                    suggestion = String.format("Computer suggest you draw from the %s pile because %s ", pile, reason);
                    break;
                }
    ...
    /** Return the pile Computer will be drawing from
     *
     * @return true if drawing from draw pile, false if discard pile
     */
    public boolean decidePile(CardVectorModel discardPile)
    {
        String reason = "";
        String pile = "";
        CombinationFinder combinationFinder;
